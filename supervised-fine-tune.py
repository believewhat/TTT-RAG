...
class SupervisedDataset(Dataset):
    ...
    def __init__(self, data_path: str, tokenizer: transformers.PreTrainedTokenizer):
        ...
        for x in list_data_dict2:
            list_data_dict.append(x.copy())
            if FT_MODE == 'doc':
                list_data_dict[-1]['input'] = 'Reference:\n' + '\nReference:\n'.join(x['doc'][:3]) + '\nQuestion:\n' + x['input']
            elif FT_MODE == 'nodoc':
                list_data_dict[-1]['input'] = '\nQuestion:\n' + x['input']
...
def train():
    ...
    if training_args.resume_from_checkpoint=='True':
        ...
        trainer.train()  # Start fresh if no checkpoint exists
